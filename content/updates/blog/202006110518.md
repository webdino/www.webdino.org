...
The analysis discussed in this post is based on log data collected by automated measuring devices (bots) and real people participating in our [Web VideoMark](http://videomark.webdino.org/) project, who use YouTube or other streaming services with the [browser extension](https://videomark.webdino.org/chromeextension) or custom Android browser installed.
